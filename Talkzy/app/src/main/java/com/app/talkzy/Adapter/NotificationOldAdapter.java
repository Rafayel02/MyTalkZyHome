...
public class NotificationOldAdapter extends RecyclerView.Adapter<NotificationOldAdapter.ViewHolder> {
    ...
    public NotificationOldAdapter(Context mContext, List<Notification> mNotifications){
    ...
    @NonNull
    @Override
    public NotificationOldAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(mContext).inflate(R.layout.notification_item, parent , false);
        return new NotificationOldAdapter.ViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull NotificationOldAdapter.ViewHolder holder, int position) {
    ...
    public void onMessageSent(Notification notification, NotificationOldAdapter.ViewHolder holder){
    ...
    public void onStoryAdded(Notification notification, NotificationOldAdapter.ViewHolder holder){
    ...
    public void onFriendReq(Notification notification, NotificationOldAdapter.ViewHolder holder){
